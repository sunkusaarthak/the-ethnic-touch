    ...
    return (
        <div className="wishlist-page-container" style={{ padding: '1.25rem 5% 3rem', maxWidth: '1200px', margin: '0 auto', minHeight: '75vh' }}>
            <div className="wishlist-header-row" style={{ marginBottom: '1.25rem' }}>
                <div>
                    <span className="profile-eyebrow" style={{ fontSize: 'var(--font-size-xs)' }}>Wardrobe Selection</span>
                    <h1 className="page-title" style={{ margin: '0.15rem 0 0' }}>Your Wishlist</h1>
                </div>
            ...
            {wishlist.length === 0 ? (
                <div style={{ textAlign: 'center', padding: '4rem 1rem', background: '#FFFdfc', borderRadius: '12px', border: '1px dashed var(--color-peach)', maxWidth: '600px', margin: '1rem auto' }}>
                    ...
                    <h2 className="section-title" style={{ marginBottom: '0.4rem' }}>Your wishlist is empty</h2>
                    <p style={{ margin: '0 auto 1.25rem', fontSize: 'var(--font-size-body)', color: 'var(--color-text-light)' }}>Explore our premium collections and tap the heart icon to save products here.</p>
                    <Link to="/shop" className="btn btn-primary" style={{ textDecoration: 'none', padding: '0.6rem 1.8rem', fontSize: 'var(--font-size-sm)', borderRadius: '50px' }}>Shop the Collection</Link>
                </div>
            ) : (
